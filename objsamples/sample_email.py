...
try:
    ...
    getHTMLBody.props = ["ID", "PartnerKey", "CreatedDate", "ModifiedDate", "Client.ID", "Name", "Folder", "CategoryID",
                         "HTMLBody", "TextBody", "Subject", "IsActive", "IsHTMLPaste", "ClonedFromID", "Status",
                         "EmailType", "CharacterSet", "HasDynamicSubjectLine", "ContentCheckStatus",
    ...
    postHTMLBody.props = {"CustomerKey": NameOfTestEmail, "Name": NameOfTestEmail,
                          "Subject": "Created Using the PythonSDK", "HTMLBody": "<b>Some HTML Goes here</b>"}
    ...
    patchHTMLBody.props = {"CustomerKey": NameOfTestEmail, "Name": NameOfTestEmail,
    ...
    deleteHTMLBody.props = {"CustomerKey": NameOfTestEmail, "Name": NameOfTestEmail,
                            "HTMLBody": "<b>Some HTML HTMLBody Goes here. NOW WITH NEW HTMLBody</b>"}
