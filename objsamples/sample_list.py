...
try:
    ...
    postList.props = {"ListName": NewListName, "Description": "This list was created with the PythonSDK",
                      "Type": "Private"}
    ...
    if postResponse.status and 'NewID' in postResponse.results[0]:
        ...
        getList.props = ["ID", "PartnerKey", "CreatedDate", "ModifiedDate", "Client.ID", "Client.PartnerClientKey",
                         "ListName", "Description", "Category", "Type", "CustomerKey", "ListClassification",
                         "AutomatedEmail.ID"]
