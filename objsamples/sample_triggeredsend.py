...
try:
    ...
    sendTrig.subscribers = [
        {"EmailAddress": "testing@bh.exacttarget.com", "SubscriberKey": "testing@bh.exacttarget.com"}]
    ...
    postTrig.props = {'CustomerKey': TSNameForCreateThenDelete, 'Name': TSNameForCreateThenDelete,
                      'Email': {"ID": "3113962"}, "SendClassification": {"CustomerKey": "2240"}}
