...
try:
    ...
    getContent.props = ["RowObjectID", "ObjectID", "ID", "CustomerKey", "Client.ID", "ModifiedDate", "CreatedDate",
    ...
    postContent.props = {"CustomerKey": NameOfTestContentArea, "Name": NameOfTestContentArea,
    ...
    patchContent.props = {"CustomerKey": NameOfTestContentArea, "Name": NameOfTestContentArea,
    ...
    deleteContent.props = {"CustomerKey": NameOfTestContentArea, "Name": NameOfTestContentArea,
                           "Content": "<b>Some HTML Content Goes here. NOW WITH NEW CONTENT</b>"}
