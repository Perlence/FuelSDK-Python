...
try:
    ...
    getFolder.props = ["ID", "Client.ID", "ParentFolder.ID", "ParentFolder.CustomerKey", "ParentFolder.ObjectID",
                       "ParentFolder.Name", "ParentFolder.Description", "ParentFolder.ContentType",
                       "ParentFolder.IsActive", "ParentFolder.IsEditable", "ParentFolder.AllowChildren", "Name",
                       "Description", "ContentType", "IsActive", "IsEditable", "AllowChildren", "CreatedDate",
                       "ModifiedDate", "Client.ModifiedBy", "ObjectID", "CustomerKey", "Client.EnterpriseID",
                       "Client.CreatedBy"]
    ...
    getFolder.search_filter = {'LeftOperand': {'Property': 'ContentType', 'SimpleOperator': 'equals', 'Value': "email"},
                               'RightOperand': {'Property': 'ParentFolder.ID', 'SimpleOperator': 'equals',
                                                'Value': "0"}, 'LogicalOperator': 'AND'}
    getResponse = getFolder.get()
    print 'Retrieve Status: ' + str(getResponse.status)
    print 'Code: ' + str(getResponse.code)
    print 'Message: ' + str(getResponse.message)
    ...
    postFolder.props = {"CustomerKey": NameOfTestFolder, "Name": NameOfTestFolder, "Description": NameOfTestFolder,
                        "ContentType": "EMAIL", "ParentFolder": {"ID": ParentIDForEmail}}
    ...
    patchFolder.props = {"CustomerKey": NameOfTestFolder, "Name": NameOfTestFolder,
