...
class Client(object):
    ...
    def items(cls, sobject):
        """
        Extract the I{items} from a et_suds object much like the
        items() method works on I{dict}.
        @param sobject: A et_suds object
    ...
    def metadata(cls, sobject):
        """
        Extract the metadata from a et_suds object.
        @param sobject: A et_suds object
        @type sobject: L{Object}
...
class ServiceSelector:
    ...
    @ivar __client: A et_suds client.
...
class SoapClient:
    ...
    def failed(self, binding, error):
        ...
        @param binding: The binding to be used to process the reply.
        @type binding: L{et_suds.bindings.binding.Binding}
